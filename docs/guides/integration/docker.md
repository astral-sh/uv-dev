...
- `ghcr.io/astral-sh/uv:{major}.{minor}.{patch}`, for example, `ghcr.io/astral-sh/uv:0.12.13`
...
`ghcr.io/astral-sh/uv:0.12.13-alpine`.
...
!!! tip
    ...
    `ghcr.io/astral-sh/uv:0.12.13`. For the strongest guarantee, verify a specific image digest, such
