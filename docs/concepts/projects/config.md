...
For packages that publish a source distribution, `required-environments` also re-resolves locked
versions that do not provide a wheel for the required environment. Packages without source
