...
impl ActivatedMarkers {
    ...
    pub fn insert_extra(&mut self, package: &PackageName, extra: &ExtraName) {
...
impl UniversalMarker {
    ...
    pub fn evaluate_activated(self, env: &MarkerEnvironment, activated: &ActivatedMarkers) -> bool {
        self.marker
    ...
    pub fn evaluate_activated_with_extras<P, E>(
        self,
        env: &MarkerEnvironment,
