...
pub struct ToolUv {
    ...
    ///
    /// For packages with a source distribution, required environments act as a best-effort
    /// preference: uv considers versions with matching wheels first and falls back to versions
