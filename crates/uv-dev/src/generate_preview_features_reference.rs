...
mod tests {
    ...
    fn generates_preview_feature_reference() {
        ...
        - <a id="include-build-dependencies" href="#include-build-dependencies"><code>include-build-dependencies</code></a>: Allows including build dependencies in `uv pip compile` output.
