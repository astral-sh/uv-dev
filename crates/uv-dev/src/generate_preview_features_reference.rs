...
mod tests {
    ...
    fn generates_preview_feature_reference() {
        ...
        - <a id="nested-workspaces" href="#nested-workspaces"><code>nested-workspaces</code></a>: Allows independently locked child workspaces to prefer their parent workspace's lockfile.
