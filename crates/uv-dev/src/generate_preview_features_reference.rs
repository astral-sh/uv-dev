...
mod tests {
    ...
    fn generates_preview_feature_reference() {
        ...
        - <a id="required-environments-mode" href="#required-environments-mode"><code>required-environments-mode</code></a>: Allows requiring compatible wheels for every dependency in required environments.
