...
use uv_distribution_types::{
    ...
    Requirement, RequiresPython, ResolutionDiagnostic, ResolvedDist, SourceDist, implied_markers,
    parse_url_hashes,
};
...
use uv_pypi_types::{
    Conflicts, HashDigests, ParsedUrl, ParsedUrlError, SupportedEnvironments, VerbatimParsedUrl,
    Yanked,
};
