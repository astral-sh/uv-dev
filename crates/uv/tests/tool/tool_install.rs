...
fn tool_install_find_links() {
    ...
    ----- stderr -----
      ...
      ╰─▶ Because basic-app==0.1 is the only available version and needs to be downloaded from a registry, we can conclude that all versions of basic-app cannot be used.
