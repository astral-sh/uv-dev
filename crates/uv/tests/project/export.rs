...
#[cfg(feature = "test-universal")]
#[test]
fn pep_751_export_no_editable_package() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR] --format pylock.toml --no-editable-package unused --no-editable-package child --no-editable-package child
    lock-version = "1.0"
    created-by = "uv"
    requires-python = ">=3.12"
