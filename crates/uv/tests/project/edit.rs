...
/// Suggest the standard-library module that caused the resolution failure when an earlier
/// standard-library dependency is unrelated.
#[test]
fn add_standard_library_multiple_dependencies_error() -> Result<()> {
    let context = uv_test::test_context!("3.12");
