...
/// A parent pins a different core release at each version. The newer core releases have identical, incompatible dependencies, so backtracking the parent repeatedly visits adjacent core versions whose prefetched metadata can share one dependency incompatibility.
///
/// ```text
/// coalesce-prefetched-dependencies
/// ├── environment
/// │   └── python3.12
/// ├── root
/// │   ├── requires leaf==1.0.0
...
/// │       ├── satisfied by parent-3.0.0
/// │       ├── satisfied by parent-3.0.1
/// │       ├── satisfied by parent-3.0.2
/// │       ├── satisfied by parent-3.0.3
/// │       ├── satisfied by parent-3.0.4
/// │       ├── satisfied by parent-3.0.5
/// │       ├── satisfied by parent-3.0.6
/// │       ├── satisfied by parent-3.0.7
/// │       ├── satisfied by parent-3.0.8
/// │       ├── satisfied by parent-3.0.9
/// │       ├── satisfied by parent-3.0.10
/// │       ├── satisfied by parent-3.0.11
/// │       ├── satisfied by parent-3.0.12
/// │       ├── satisfied by parent-3.0.13
/// │       ├── satisfied by parent-3.0.14
/// │       ├── satisfied by parent-3.0.15
/// │       ├── satisfied by parent-3.0.16
/// │       ├── satisfied by parent-3.0.17
/// │       ├── satisfied by parent-3.0.18
/// │       ├── satisfied by parent-3.0.19
/// │       ├── satisfied by parent-3.0.20
/// │       ├── satisfied by parent-3.0.21
/// │       ├── satisfied by parent-3.0.22
/// │       ├── satisfied by parent-3.0.23
/// │       ├── satisfied by parent-3.0.24
/// │       ├── satisfied by parent-3.0.25
/// │       ├── satisfied by parent-3.0.26
/// │       ├── satisfied by parent-3.0.27
/// │       ├── satisfied by parent-3.0.28
/// │       ├── satisfied by parent-3.0.29
/// │       └── satisfied by parent-3.0.30
/// ├── core
/// │   ├── core-2.0.0
/// │   │   └── requires leaf==1.0.0
/// │   │       └── satisfied by leaf-1.0.0
...
///     ├── parent-2.0.0
///     │   └── requires core==2.0.0
///     │       └── satisfied by core-2.0.0
///     ├── parent-3.0.0
///     │   └── requires core==3.0.0
///     │       └── satisfied by core-3.0.0
///     ├── parent-3.0.1
///     │   └── requires core==3.0.1
///     │       └── satisfied by core-3.0.1
///     ├── parent-3.0.2
///     │   └── requires core==3.0.2
///     │       └── satisfied by core-3.0.2
///     ├── parent-3.0.3
///     │   └── requires core==3.0.3
///     │       └── satisfied by core-3.0.3
///     ├── parent-3.0.4
///     │   └── requires core==3.0.4
///     │       └── satisfied by core-3.0.4
///     ├── parent-3.0.5
///     │   └── requires core==3.0.5
///     │       └── satisfied by core-3.0.5
///     ├── parent-3.0.6
///     │   └── requires core==3.0.6
///     │       └── satisfied by core-3.0.6
///     ├── parent-3.0.7
///     │   └── requires core==3.0.7
///     │       └── satisfied by core-3.0.7
///     ├── parent-3.0.8
///     │   └── requires core==3.0.8
///     │       └── satisfied by core-3.0.8
///     ├── parent-3.0.9
///     │   └── requires core==3.0.9
///     │       └── satisfied by core-3.0.9
///     ├── parent-3.0.10
///     │   └── requires core==3.0.10
///     │       └── satisfied by core-3.0.10
///     ├── parent-3.0.11
///     │   └── requires core==3.0.11
///     │       └── satisfied by core-3.0.11
///     ├── parent-3.0.12
///     │   └── requires core==3.0.12
///     │       └── satisfied by core-3.0.12
///     ├── parent-3.0.13
///     │   └── requires core==3.0.13
///     │       └── satisfied by core-3.0.13
///     ├── parent-3.0.14
///     │   └── requires core==3.0.14
///     │       └── satisfied by core-3.0.14
///     ├── parent-3.0.15
///     │   └── requires core==3.0.15
///     │       └── satisfied by core-3.0.15
///     ├── parent-3.0.16
///     │   └── requires core==3.0.16
///     │       └── satisfied by core-3.0.16
///     ├── parent-3.0.17
///     │   └── requires core==3.0.17
///     │       └── satisfied by core-3.0.17
///     ├── parent-3.0.18
///     │   └── requires core==3.0.18
///     │       └── satisfied by core-3.0.18
///     ├── parent-3.0.19
///     │   └── requires core==3.0.19
///     │       └── satisfied by core-3.0.19
///     ├── parent-3.0.20
///     │   └── requires core==3.0.20
///     │       └── satisfied by core-3.0.20
///     ├── parent-3.0.21
///     │   └── requires core==3.0.21
///     │       └── satisfied by core-3.0.21
///     ├── parent-3.0.22
///     │   └── requires core==3.0.22
///     │       └── satisfied by core-3.0.22
///     ├── parent-3.0.23
///     │   └── requires core==3.0.23
///     │       └── satisfied by core-3.0.23
///     ├── parent-3.0.24
///     │   └── requires core==3.0.24
///     │       └── satisfied by core-3.0.24
///     ├── parent-3.0.25
///     │   └── requires core==3.0.25
///     │       └── satisfied by core-3.0.25
///     ├── parent-3.0.26
///     │   └── requires core==3.0.26
///     │       └── satisfied by core-3.0.26
///     ├── parent-3.0.27
///     │   └── requires core==3.0.27
///     │       └── satisfied by core-3.0.27
///     ├── parent-3.0.28
///     │   └── requires core==3.0.28
///     │       └── satisfied by core-3.0.28
///     ├── parent-3.0.29
///     │   └── requires core==3.0.29
///     │       └── satisfied by core-3.0.29
///     └── parent-3.0.30
///         └── requires core==3.0.30
///             └── satisfied by core-3.0.30
/// ```
#[test]
fn coalesce_prefetched_dependencies() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let python_versions = &[];
    let server = PackseServer::new("backtracking/coalesce-prefetched-dependencies.toml");
    ...
    output
        .assert()
        .success()
        .stdout(predicate::str::contains("core==2.0.0"))
        .stdout(predicate::str::contains("leaf==1.0.0"))
        .stdout(predicate::str::contains("parent==2.0.0"));

    Ok(())
}

/// Reuse the lowest direct dependency when its Python marker contains the active interpreter.
///
/// ```text
/// lowest-direct-fork-max-python
/// ├── environment
/// │   └── python3.11
/// ├── root
/// │   ├── requires forkdep>=2.8 ; python_full_version < '3.12'
/// │   │   ├── satisfied by forkdep-2.8
/// │   │   ├── satisfied by forkdep-3.0
/// │   │   └── satisfied by forkdep-3.1
/// │   └── requires forkroot==3.0.0
/// │       └── satisfied by forkroot-3.0.0
/// ├── forkdep
/// │   ├── forkdep-2.8
/// │   │   └── requires python>=0
/// │   ├── forkdep-3.0
...
/// └── forkroot
///     └── forkroot-3.0.0
///         ├── requires forkdep>=2.8
///         │   ├── satisfied by forkdep-2.8
///         │   ├── satisfied by forkdep-3.0
///         │   └── satisfied by forkdep-3.1
///         ├── requires forkleaf>=1.1
...
fn lowest_direct_fork_max_python() -> Result<()> {
    ...
    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str("forkroot==3.0.0\nforkdep>=2.8 ; python_full_version < '3.12'")?;
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile requirements.in --cache-dir [CACHE_DIR] --resolution=lowest-direct --universal
    forkdep==2.8
        # via
        #   -r requirements.in
        #   forkroot
    ...
    output
        .assert()
        .success()
        .stdout(predicate::str::contains("forkdep==2.8"))
        .stdout(predicate::str::contains("forkleaf==1.1.0"))
        .stdout(predicate::str::contains("forkroot==3.0.0"));

    Ok(())
}

/// Prefer the lowest direct dependency only where a Python marker makes it direct.
///
/// ```text
/// lowest-direct-fork-min-python
/// ├── environment
/// │   └── python3.11
/// ├── root
/// │   ├── requires forkdep>=3 ; python_full_version >= '3.12'
/// │   │   ├── satisfied by forkdep-3.0
/// │   │   └── satisfied by forkdep-3.1
/// │   └── requires forkroot==3.0.0
/// │       └── satisfied by forkroot-3.0.0
...
fn lowest_direct_fork_min_python() -> Result<()> {
    let context = uv_test::test_context!("3.11");
    let python_versions = &[];
    let server = PackseServer::new("fork/lowest-direct-fork-min-python.toml");

    let requirements_in = context.temp_dir.child("requirements.in");
    requirements_in.write_str("forkroot==3.0.0\nforkdep>=3 ; python_full_version >= '3.12'")?;
    ...
    # This file was autogenerated by uv via the following command:
    #    uv pip compile requirements.in --cache-dir [CACHE_DIR] --resolution=lowest-direct --universal
    forkdep==3.0 ; python_full_version >= '3.12'
        # via
        #   -r requirements.in
        #   forkroot
    forkdep==3.1 ; python_full_version < '3.12'
        # via
        #   -r requirements.in
        #   forkroot
    forkleaf==1.1.0
    ...
    output
        .assert()
        .success()
        .stdout(predicate::str::contains("forkdep==3.1"))
        .stdout(predicate::str::contains("forkleaf==1.1.0"))
        .stdout(predicate::str::contains("forkroot==3.0.0"));
...
/// Reuse the lowest version when a direct Python marker contains the active interpreter.
///
/// ```text
/// lowest-fork-max-python
/// ├── environment
/// │   └── python3.11
/// ├── root
/// │   ├── requires forkdep>=2.8 ; python_full_version < '3.12'
...
fn lowest_fork_max_python() -> Result<()> {
    let context = uv_test::test_context!("3.11");
    let python_versions = &[];
    let server = PackseServer::new("fork/lowest-fork-max-python.toml");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile requirements.in --cache-dir [CACHE_DIR] --resolution=lowest --universal
    forkdep==2.8
        # via
        #   -r requirements.in
        #   forkroot
...
/// Select different lowest versions where a Python marker raises the direct lower bound.
///
/// ```text
/// lowest-fork-min-python
/// ├── environment
/// │   └── python3.11
/// ├── root
/// │   ├── requires forkdep>=3 ; python_full_version >= '3.12'
...
fn lowest_fork_min_python() -> Result<()> {
    let context = uv_test::test_context!("3.11");
    let python_versions = &[];
    let server = PackseServer::new("fork/lowest-fork-min-python.toml");
    ...
    output
        .assert()
        .success()
        .stdout(predicate::str::contains("forkdep==3.0"))
        .stdout(predicate::str::contains("forkleaf==1.1.0"))
        .stdout(predicate::str::contains("forkroot==3.0.0"));
