...
fn alternative_dependencies_only_no_build() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because dependency<=1.5.0 has no usable wheels and parent<=1.0.0 depends on dependency<2, we can conclude that parent<=1.0.0 cannot be used. (1)

          Because dependency>=2.0.0 has no usable wheels and parent>=2.0.0 depends on dependency>=2, we can conclude that parent>=2.0.0 cannot be used.
          And because we know from (1) that parent<=1.0.0 cannot be used, we can conclude that all versions of parent cannot be used.
          And because you require parent, we can conclude that your requirements are unsatisfiable.
...
fn no_sdist_no_wheels_with_matching_abi() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because a==1.0.0 is the only available version and has no wheels with a matching Python ABI tag (e.g., `cp312`), we can conclude that all versions of a cannot be used.
          And because you require a, we can conclude that your requirements are unsatisfiable.
...
fn no_sdist_no_wheels_with_matching_platform() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because a==1.0.0 is the only available version and has no wheels with a matching platform tag (e.g., `manylinux_2_17_x86_64`), we can conclude that all versions of a cannot be used.
          And because you require a, we can conclude that your requirements are unsatisfiable.
...
fn no_sdist_no_wheels_with_matching_python() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because a==1.0.0 is the only available version and has no wheels with a matching Python implementation tag (e.g., `cp312`), we can conclude that all versions of a cannot be used.
          And because you require a, we can conclude that your requirements are unsatisfiable.
...
fn no_wheels_no_build() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because a==1.0.0 is the only available version and has no usable wheels, we can conclude that all versions of a cannot be used.
          And because you require a, we can conclude that your requirements are unsatisfiable.
...
fn only_wheels_no_binary() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because a==1.0.0 is the only available version and has no source distribution, we can conclude that all versions of a cannot be used.
          And because you require a, we can conclude that your requirements are unsatisfiable.
...
fn alternative_dependencies_only_yanked() {
    ...
    ----- stderr -----
      ...
      ╰─▶ Because dependency<=1.5.0 was yanked and parent<=1.0.0 depends on dependency<2, we can conclude that parent<=1.0.0 cannot be used. (1)
          ...
          Because dependency>=2.0.0 was yanked and parent>=2.0.0 depends on dependency>=2, we can conclude that parent>=2.0.0 cannot be used.
          And because we know from (1) that parent<=1.0.0 cannot be used, we can conclude that all versions of parent cannot be used.
          And because you require parent, we can conclude that your requirements are unsatisfiable.
    ");
...
fn package_only_yanked() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because a==1.0.0 is the only available version and was yanked, we can conclude that all versions of a cannot be used.
          And because you require a, we can conclude that your requirements are unsatisfiable.
    ");
...
fn transitive_package_only_yanked() {
    ...
    ----- stderr -----
      × No solution found when resolving dependencies:
      ╰─▶ Because b==1.0.0 is the only available version and was yanked, we can conclude that all versions of b cannot be used.
