...
#[test]
fn build_policy_if_necessary_preserves_selected_versions() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "build-policy"
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary
    source-only==1.0.0
        # via -r requirements.in
    wheel-backed==1.0.0
        # via -r requirements.in
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary --no-binary wheel-backed
    source-only==1.0.0
        # via -r requirements.in
    wheel-backed==1.0.0
        # via -r requirements.in
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary --emit-build-options -o requirements.txt
    --only-binary wheel-backed
...
/// Exercise the policy vocabulary, package overrides, and preview warning.
#[test]
fn build_policy_modes() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "build-policy-modes"
        [root]
        [expected]
        satisfiable = true
        [packages.source-only.versions."0.9.0"]
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --emit-build-options --build-policy if-necessary
    --only-binary wheel-backed
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy disallow --emit-build-options
    --only-binary source-only
    --only-binary wheel-backed
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("disallow")
        .arg("--build-policy-package").arg("source-only=allow")
        .arg("--build-policy-package").arg("wheel-backed=force")
        .arg("--emit-build-options")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy disallow --build-policy-package source-only=allow --build-policy-package wheel-backed=force --emit-build-options
    --no-binary wheel-backed
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy force --build-policy-package wheel-backed=disallow --emit-build-options
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("if-necessary")
        .arg("--build-policy-package").arg("wheel-backed=allow")
        .arg("--emit-build-options")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary --build-policy-package wheel-backed=allow --emit-build-options
    source-only==1.0.0
        # via -r requirements.in
    wheel-backed==1.0.0
        # via -r requirements.in
    ...
    context.temp_dir.child("uv.toml").write_str(indoc! {r#"
        ...
        build-policy-package = { wheel-backed = "force" }
    "#})?;
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy-package source-only=allow --build-policy-package wheel-backed=disallow --emit-build-options
    --only-binary wheel-backed
...
/// Merge global and package policies across top-level, pip, and command-line settings.
#[test]
fn build_policy_configuration_precedence() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "build-policy-precedence"
        [root]
        [expected]
        satisfiable = true
        [packages.source-only.versions."0.9.0"]
        [packages.source-only.versions."1.0.0"]
        wheel = false
        [packages.defaulted.versions."0.9.0"]
        [packages.defaulted.versions."1.0.0"]
        wheel = false
        [packages.wheel-backed.versions."1.0.0"]
    "#})?;
    let server = PackseServer::from_scenario(&scenario);
    context
        .temp_dir
        .child("requirements.in")
        .write_str("source-only\ndefaulted\nwheel-backed")?;
    context.temp_dir.child("uv.toml").write_str(indoc! {r#"
        preview-features = ["build-policy"]
        build-policy = "disallow"
        build-policy-package = { source-only = "allow", wheel-backed = "force" }

        [pip]
        build-policy = "if-necessary"
        build-policy-package = { wheel-backed = "allow" }
    "#})?;
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --emit-build-options
    defaulted==1.0.0
        # via -r requirements.in
    source-only==1.0.0
        # via -r requirements.in
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("disallow")
        .arg("--build-policy-package").arg("source-only=disallow")
        .arg("--build-policy-package").arg("wheel-backed=disallow")
        .arg("--build-policy-package").arg("wheel-backed=force")
        .arg("--emit-build-options"), @"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy disallow --build-policy-package source-only=disallow --build-policy-package wheel-backed=disallow --build-policy-package wheel-backed=force --emit-build-options
    --no-binary wheel-backed
    --only-binary defaulted
    --only-binary source-only
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --no-config --build-policy-package source-only=allow
    defaulted==1.0.0
        # via -r requirements.in
    source-only==1.0.0
        # via -r requirements.in
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--build-policy").arg("source-only=allow"), @"
    exit_code: 2 (failure)
    ----- stderr -----
    error: invalid value 'source-only=allow' for '--build-policy <BUILD_POLICY>'
      [possible values: allow, if-necessary, disallow, force]

    For more information, try '--help'.
    ");
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--build-policy-package").arg("allow"), @"
    exit_code: 2 (failure)
    ----- stderr -----
    error: invalid value 'allow' for '--build-policy-package <BUILD_POLICY_PACKAGE>': invalid `build-policy-package` value `allow`: expected `PACKAGE=POLICY`
...
fn build_policy_install_sync() -> Result<()> {
    ...
    ----- stderr -----
    Resolved 1 package in [TIME]
      × Failed to download and build `source-only==1.0.0`
      ├─▶ Failed to resolve requirements from `build-system.requires`
      ├─▶ No solution found when resolving: `hatchling`
      ╰─▶ Because hatchling==1.20.0 has no source distribution and only hatchling==1.20.0 is available, we can conclude that all versions of hatchling cannot be used.
...
/// Concrete coverage must use the requested platform, not merely the presence of a wheel.
#[cfg(feature = "test-universal")]
#[test]
fn build_policy_if_necessary_incompatible_wheel() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "build-policy-incompatible-wheel"
        [root]
        [expected]
        satisfiable = true
        [packages.platform-specific.versions."0.9.0"]
        [packages.platform-specific.versions."1.0.0"]
    ...
    context
        .temp_dir
        .child("requirements.in")
        .write_str("platform-specific>=0.9")?;
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --python-platform x86_64-unknown-linux-gnu --build-policy if-necessary --emit-build-options
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("--python-platform").arg("x86_64-pc-windows-msvc")
        .arg("--build-policy").arg("if-necessary")
        .arg("--emit-build-options")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --python-platform x86_64-pc-windows-msvc --build-policy if-necessary --emit-build-options
    --only-binary platform-specific
...
/// Wheels excluded by `--exclude-newer` do not satisfy `if-necessary`.
#[tokio::test]
async fn build_policy_if_necessary_excluded_wheel() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let server = MockServer::start().await;
    Mock::given(method("GET"))
        .and(path("/simple/mixed/"))
        .respond_with(ResponseTemplate::new(200).set_body_raw(
            r#"{
                ...
                "files": [
                    {
                        "filename": "mixed-1.0.0.tar.gz",
                        "url": "mixed-1.0.0.tar.gz",
                        "hashes": {},
                        "upload-time": "2024-01-01T00:00:00Z"
                    },
                    {
                        "filename": "mixed-1.0.0-py3-none-any.whl",
                        "url": "mixed-1.0.0-py3-none-any.whl",
                        "hashes": {},
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--exclude-newer").arg("2024-06-01")
        .arg("--build-policy").arg("if-necessary")
        .arg("--emit-build-options")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --exclude-newer 2024-06-01 --build-policy if-necessary --emit-build-options
    mixed==1.0.0
        # via -r requirements.in
...
/// Yanked wheels retained for metadata do not satisfy `if-necessary`.
#[tokio::test]
async fn build_policy_if_necessary_yanked_wheel() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let server = MockServer::start().await;
    Mock::given(method("GET"))
        .and(path("/simple/mixed/"))
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary --emit-build-options
    mixed==1.0.0
        # via -r requirements.in
...
/// Resolve `if-necessary` per selected version, but aggregate emitted pip flags by package.
#[cfg(feature = "test-universal")]
#[test]
fn build_policy_if_necessary_multiple_versions() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "build-policy-multiple-versions"
        [root]
        [expected]
        satisfiable = true
    ...
    context.temp_dir.child("requirements.in").write_str(
        "foo==1.0.0; sys_platform == 'linux' and platform_machine == 'x86_64' and python_version < '4'\n\
             foo==2.0.0; sys_platform == 'win32' and platform_machine == 'AMD64' and python_version < '4'",
    )?;
    ...
    let foo_1 = packages
        .iter()
        .find(|package| package["version"].as_str() == Some("1.0.0"))
        .unwrap();
    let foo_2 = packages
        .iter()
        .find(|package| package["version"].as_str() == Some("2.0.0"))
        .unwrap();
    assert!(foo_1.get("sdist").is_none(), "{foo_1:#?}");
    assert!(foo_1.get("wheels").is_some());
    assert!(foo_2.get("sdist").is_some());
    assert!(foo_2.get("wheels").is_none());
...
/// Discover an unnamed source's metadata before applying a package-specific build exception.
#[test]
fn build_policy_unnamed_source_metadata() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    context
        .temp_dir
        .child("requirements.in")
    ...
    project.child("backend.py").write_str(indoc! {r#"
        ...
        def prepare_metadata_for_build_wheel(metadata_directory, config_settings=None):
            ...
            directory = Path(metadata_directory) / "review_pkg-1.0.0.dist-info"
            directory.mkdir()
    ...
    // A package-specific policy exception requires discovering an unnamed source's name before
    // deciding whether builds are allowed, so the backend runs for metadata.
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in").arg("--no-index").arg("--no-cache")
        .arg("--build-policy").arg("disallow")
        .arg("--build-policy-package").arg("unrelated=allow")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --no-index --no-cache --build-policy disallow --build-policy-package unrelated=allow
    ./project
        # via -r requirements.in
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in").arg("--no-index").arg("--no-cache")
        .arg("--build-policy").arg("disallow")
        .arg("--no-binary").arg("review-pkg")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --no-index --no-cache --build-policy disallow --no-binary review-pkg
    ./project
        # via -r requirements.in
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --no-index --no-cache --build-policy if-necessary
    ./project
        # via -r requirements.in
...
#[cfg(feature = "test-universal")]
#[test]
fn build_policy_if_necessary_universal_required_environments() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "build-policy-universal"
    ...
    context
        ...
        required-environments = [
            "sys_platform == 'win32' and platform_machine == 'AMD64' and python_version < '4'",
            "sys_platform == 'linux' and platform_machine == 'x86_64' and python_version < '4'",
        ]
