...
fn pep723_requirements_sources_and_indexes() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.pip_compile().arg(script.path()), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] [TEMP_DIR]/scripts/requirements.py
    ../links/ok-1.0.0-py3-none-any.whl
    tqdm==1000.0.0
