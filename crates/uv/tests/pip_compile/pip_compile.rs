...
#[test]
fn build_policy_fallback_preserves_selected_versions() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
        name = "build-policy"
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("fallback")
        .arg("--generate-hashes")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy fallback --generate-hashes
    source-only==1.0.0 \
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy fallback --no-binary wheel-backed --generate-hashes
    source-only==1.0.0 \
        --hash=sha256:e7ead2a0decd519afce6959e902a8b0dec7e75fe611c183ef14139a36915a669
        # via -r requirements.in
    wheel-backed==1.0.0 \
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy fallback --emit-build-options --generate-hashes -o requirements.txt
...
fn build_policy_modes() -> Result<()> {
    ...
    exit_code: 2 (failure)
    ----- stderr -----
    error: The `--build-policy` option requires `--preview-features build-policy`
    ");

    uv_snapshot!(context.filters(), context.pip_install()
        .arg("source-only")
        .arg("--build-policy").arg("deny"), @"
    exit_code: 2 (failure)
    ----- stderr -----
    error: The `--build-policy` option requires `--preview-features build-policy`
    ");
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy deny --emit-build-options
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("deny")
        .arg("--build-policy").arg("source-only=allow,wheel-backed=force")
        .arg("--emit-build-options")
        .arg("--generate-hashes")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy deny --build-policy source-only=allow,wheel-backed=force --emit-build-options --generate-hashes
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        ...
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("force")
        .arg("--build-policy").arg("wheel-backed=deny")
        .arg("--emit-build-options")
        .arg("--generate-hashes")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy force --build-policy wheel-backed=deny --emit-build-options --generate-hashes
    ...
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("fallback,wheel-backed=allow")
        .arg("--emit-build-options")
        .arg("--generate-hashes")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @r"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy fallback,wheel-backed=allow --emit-build-options --generate-hashes
    source-only==1.0.0 \
        --hash=sha256:e7ead2a0decd519afce6959e902a8b0dec7e75fe611c183ef14139a36915a669
        # via -r requirements.in
    wheel-backed==1.0.0 \
    ...
    context.temp_dir.child("uv.toml").write_str(indoc! {r#"
        ...
        [pip]
        build-policy = ["deny", "wheel-backed=force"]
    "#})?;
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("source-only=allow,wheel-backed=deny")
        .arg("--emit-build-options"), @"
    exit_code: 0 (success)
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy source-only=allow,wheel-backed=deny --emit-build-options
    --only-binary wheel-backed
    ...
    hint: Wheels are required for `source-only` because its build policy is `deny`
    ");
...
fn build_policy_install_sync() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.pip_sync()
        .arg("requirements.txt")
        .arg("--index-url").arg(server.index_url())
        .arg("--build-policy").arg("source-only=force")
        .env(EnvVars::UV_PREVIEW_FEATURES, "build-policy"), @"
    exit_code: 0 (success)
    ----- stderr -----
    Resolved 1 package in [TIME]
...
#[cfg(feature = "test-universal")]
#[test]
fn build_policy_fallback_universal_required_environments() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario = toml::from_str::<Scenario>(indoc! {r#"
