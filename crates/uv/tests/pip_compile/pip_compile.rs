...
/// Require wheels in the configured environment only when the preview mode is enabled.
#[cfg(feature = "test-universal")]
#[test]
fn universal_required_environment_requires_matching_wheel() -> Result<()> {
    let context = uv_test::test_context!("3.12");
    let scenario: Scenario = toml::from_str(
        r#"
        name = "required-environment-pip-compile"
