...
fn requires_python_extra_causality() -> Result<()> {
    ...
    ----- stderr -----
    error: No solution found when resolving dependencies
      cause: Because the requested Python version (>=3.12) does not satisfy Python>=3.13 and python-causality==1.0.0 depends on Python>=3.13, we can conclude that python-causality==1.0.0 cannot be used.
    ...
    ----- stderr -----
    error: No solution found when resolving dependencies
      cause: Because the requested Python version (>=3.12) does not satisfy Python>=3.13 and python-causality[feature]==1.0.0 depends on Python>=3.13, we can conclude that python-causality[feature]==1.0.0 cannot be used.
