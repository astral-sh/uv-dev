...
fn compile_reversed_python_version_in_marker() -> Result<()> {
    ...
    // This marker is false for Python 3.9, so the requirement should be omitted.
    uv_snapshot!(context.filters(), context.pip_compile()
        .arg("requirements.in")
        .arg("--python-version")
        .arg("3.9")
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --python-version 3.9 --no-index
