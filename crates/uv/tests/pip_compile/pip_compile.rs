...
fn build_policy_if_necessary_preserves_selected_versions() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary --no-binary wheel-backed --generate-hashes
    source-only==1.0.0 \
        --hash=sha256:e7ead2a0decd519afce6959e902a8b0dec7e75fe611c183ef14139a36915a669
        # via -r requirements.in
    wheel-backed==1.0.0 \
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary --emit-build-options --generate-hashes -o requirements.txt
...
fn build_policy_modes() -> Result<()> {
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy disallow --build-policy-package source-only=allow --build-policy-package wheel-backed=force --emit-build-options --generate-hashes
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy force --build-policy-package wheel-backed=disallow --emit-build-options --generate-hashes
    ...
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --build-policy if-necessary --build-policy-package wheel-backed=allow --emit-build-options --generate-hashes
    source-only==1.0.0 \
        --hash=sha256:e7ead2a0decd519afce6959e902a8b0dec7e75fe611c183ef14139a36915a669
        # via -r requirements.in
    wheel-backed==1.0.0 \
