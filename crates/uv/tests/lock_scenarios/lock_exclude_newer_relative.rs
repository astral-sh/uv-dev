...
fn lock_exclude_newer_relative_values() -> Result<()> {
    ...
    error: No solution found when resolving dependencies
      cause: there are no versions of iniconfig and iniconfig==2.0.0 was published after the exclude newer time, so all versions of iniconfig cannot be used.
             And your project depends on iniconfig.
