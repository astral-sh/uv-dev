...
fn extra_basic() -> Result<()> {
    ...
    error: No solution found when resolving dependencies
      cause: project[extra2] depends on sortedcontainers==2.4.0 and project[extra1] depends on sortedcontainers==2.3.0, so project[extra1] and project[extra2] are incompatible.
             And your project requires project[extra1] and project[extra2].
    ");
...
fn extra_basic_three_extras() -> Result<()> {
    ...
    ----- stderr -----
    error: No solution found when resolving dependencies
      cause: project[extra2] depends on sortedcontainers==2.3.0 and project[extra1] depends on sortedcontainers==2.2.0, so project[extra1] and project[extra2] are incompatible.
             And your project requires project[extra1] and project[extra2].
    ");
...
fn extra_multiple_not_conflicting2() -> Result<()> {
    ...
    error: No solution found when resolving dependencies for split (included: project[extra2], project[project3]; excluded: project[extra1], project[project4])
      cause: project[project3] depends on sortedcontainers==2.3.0 and project[extra2] depends on sortedcontainers==2.4.0, so project[extra2] and project[project3] are incompatible.
             And your project requires project[extra2] and project[project3].
    ");
...
fn extra_nested_across_workspace() -> Result<()> {
    ...
    error: No solution found when resolving dependencies for split (included: dummy[extra2], dummysub[extra1]; excluded: dummy[extra1], dummysub[extra2])
      cause: dummy[extra2] depends on proxy1[extra2] and only proxy1[extra2]==0.1.0 is available, so dummy[extra2] depends on proxy1[extra2]==0.1.0. (1)

             proxy1[extra1]==0.1.0 depends on anyio==4.1.0 and proxy1[extra2]==0.1.0 depends on anyio==4.2.0, so proxy1[extra1]==0.1.0 and proxy1[extra2]==0.1.0 are incompatible.
             And dummy[extra2] depends on proxy1[extra2]==0.1.0 (1), so dummy[extra2] and proxy1[extra1]==0.1.0 are incompatible.
             And only proxy1[extra1]==0.1.0 is available and dummysub[extra1] depends on proxy1[extra1], so dummysub[extra1] and dummy[extra2] are incompatible.
             And your workspace requires dummy[extra2] and dummysub[extra1].
    ");
...
fn extra_depends_on_conflicting_extra() -> Result<()> {
    ...
    error: No solution found when resolving dependencies for split (included: example[foo]; excluded: example[bar])
      cause: example[foo] depends on sortedcontainers==2.3.0 and sortedcontainers==2.4.0, so example[foo]'s requirements are unsatisfiable.
             And your project requires example[foo].
    ");
...
fn group_basic() -> Result<()> {
    ...
    ----- stderr -----
    error: No solution found when resolving dependencies
      cause: project:group2 depends on sortedcontainers==2.4.0 and project:group1 depends on sortedcontainers==2.3.0, so project:group1 and project:group2 are incompatible.
             And your project requires project:group1 and project:group2.
    ");
...
fn group_virtual() -> Result<()> {
    ...
    error: No solution found when resolving dependencies
      cause: you require sortedcontainers==2.3.0 and sortedcontainers==2.4.0.
    ");
...
fn mixed() -> Result<()> {
    ...
    ----- stderr -----
    error: No solution found when resolving dependencies
      cause: project:group1 depends on sortedcontainers==2.3.0 and project[extra1] depends on sortedcontainers==2.4.0, so project:group1 and project[extra1] are incompatible.
             And your project requires project[extra1] and project:group1.
    ");
